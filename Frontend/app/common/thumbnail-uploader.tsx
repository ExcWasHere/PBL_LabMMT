...
export default function ThumbnailUploader({ url, date, type, onUpload, onRemove }: ThumbnailUploaderProps) {
  return (
    <div>
        ...
        <div className="relative group w-full md:w-96 aspect-video bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300 overflow-hidden hover:border-orange-500 transition-colors">
          {url ? (
            ...
            <label className="flex flex-col items-center justify-center w-full h-full cursor-pointer">
              ...
              <span className="text-xs text-gray-400 mt-1">rec. size 1280x720</span>
              <input
                type="file"
                accept="image/*"
                className="hidden"
