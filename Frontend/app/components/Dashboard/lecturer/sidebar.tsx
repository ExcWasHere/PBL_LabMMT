...
const Sidebar: FC = () => {
  ...
  const menuTop: MenuItem[] = [
    { name: "Dashboard", route: "/dashboard-lecturer", icon: <LayoutGrid size={18} /> },
    { name: "Project", route: "/dashboard-lecturer-project", icon: <FolderKanban size={18} /> },
    { name: "News", route: "/dashboard-lecturer-news", icon: <Newspaper size={18} /> },
    { name: "Gallery", route: "/dashboard-lecturer-gallery", icon: <ImageIcon size={18} /> },
    { name: "Members", route: "/dashboard-lecturer-member", icon: <Users2 size={18} /> },
  ];
