...
export default [
    ...
    route("dashboard-student", "routes/dashboard-viewer/dashboard.tsx"),
    route("dashboard-student-news", "routes/dashboard-viewer/news.tsx"),
    route("dashboard-student-project", "routes/dashboard-viewer/project.tsx"),
    route("dashboard-student-gallery", "routes/dashboard-viewer/gallery.tsx"),
    route("dashboard-student-member", "routes/dashboard-viewer/member.tsx"),
    route("dashboard-admin", "routes/dashboard-viewer/dashboard.tsx"),
    route("dashboard-admin-news", "routes/dashboard-viewer/news.tsx"),
    route("dashboard-admin-project", "routes/dashboard-viewer/project.tsx"),
    route("dashboard-admin-gallery", "routes/dashboard-viewer/gallery.tsx"),
    route("dashboard-admin-member", "routes/dashboard-viewer/member.tsx"),
